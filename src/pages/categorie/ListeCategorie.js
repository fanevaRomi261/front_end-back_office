...
const ListeCategorie = () => {
    ...
    const [categorieToInsert,setCategorieToInsert] = useState(initialValue);
        ...
        <Container className="mt--9" fluid>
            ...
            <div className="col-md-6">
                ...
                <CardHeader className="bg-transparent border-0">
                    <h3 className="text-white mb-0">Categorie</h3>
                ...
                >
                    ...
                    <React.Fragment key={1}>
                        ...
                        {listeCategorie?.map((liste, index) => (
                        ...
                        <tr>
                            ...
                            <UncontrolledDropdown>
                                ...
                                <Link to={`/admin/modifierCategorie/${liste.id}`}>
                                    <DropdownItem>
                                        Modifier
                                    </DropdownItem>
                                </Link>
